...
## 🚀 Current Work
- Agentic Product & Growth Lead @ Agentman  (check out my meeting booker agent using cal.com here: cal-scheduling-agent (https://github.com/gayatriseeth/cal-scheduling-agent) )
